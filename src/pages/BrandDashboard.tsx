...
import { FiPlus, FiActivity, FiUsers, FiHeart, FiDollarSign, FiChevronRight, FiBell, FiMessageSquare, FiAlertCircle } from "react-icons/fi"
...
export function BrandDashboard() {
  ...
  // Use the first 4 campaigns as recent
  const recentCampaigns = campaignsData.slice(0, 4)
